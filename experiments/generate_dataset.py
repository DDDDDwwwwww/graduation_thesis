...
def run_single_game(game, agents, game_name, match_id, playclock, rng, sampling_mode, sample_rate):
...
def main():
    ...
    parser.add_argument("--agent", choices=["pure_mct", "heuristic_mcts"], default="pure_mct")
