...
\node[draw=none, font=\Large\bfseries, anchor=west] (title) at (-0.2,4.0) {SDRPV Overall Pipeline};
\node[draw=none, font=\small, text=black!70, anchor=west] at (-0.2,3.55) {Main line: data construction $\rightarrow$ supervision learning $\rightarrow$ online search integration};
