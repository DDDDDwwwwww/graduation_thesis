...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/chapter4/system_architecture.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\linewidth]{figures/chapter4/rule_state_machine_class_diagram.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/chapter4/search_agent_class_diagram.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/chapter4/state_encoding_value_pipeline.pdf}
